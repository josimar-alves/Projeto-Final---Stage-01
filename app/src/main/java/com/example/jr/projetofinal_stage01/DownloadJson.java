...
public class DownloadJson extends AsyncTask<String, Void, List<Filme>> {
    ...
    private List<Filme> getJson(String jsonStr) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            filme = new Filme("http://image.tmdb.org/t/p/w185" + f.getString("poster_path"), f.getString("overview"), f.getString("release_date"), f.getString("original_title"), f.getString("original_language"), f.getString("title"));
